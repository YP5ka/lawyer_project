    ...
    return(
        <>
            ...
            <div className="bg-[url('/images/bg-top.jpg')] h-[40rem] bg-no-repeat bg-cover bg-center mt-2 flex items-center" >
                <div className='flex flex-col min-[1600px]:ml-80 min-[1400px]:ml-20 px-4  items-start ml-8 '>
                    <h1 className=' text-white min-[1200px]:text-6xl mb-10 font-bold text-4xl  min-[1600px]:max-w-2xl'>Жолнерович Валентина - услуги юриста и адвоката в Мурманске</h1>
                    <h3 className=' text-white mb-16 text-lg  min-[1600px]:max-w-2xl'>Моя постоянная работа - это решение проблем, с которыми вы столкнулись впервые. Более 20 лет опыта в рамках юридической специальности.</h3>
                    <RequestModal/>
                </div>
            </div>
