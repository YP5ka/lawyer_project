...
const Projects = () => {
  return (
    <>
    <div className="flex flex-col items-center w-full px-4 md:px-48 xl:px-80 " >
        <div className="mt-8 ">
            ...
            <div className="flex mt-12 items-start">
                ...
                <div className="ml-6 py-3 max-w-[800px]">
                    ...
                    <p className="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta, deleniti hic, 
                        inventore consequatur voluptatum, doloremque harum eligendi fugiat tempora nam quas error ad laudantium ipsam laborum numquam iste perferendis quis.</p>
                </div>
            </div>
        </div>
